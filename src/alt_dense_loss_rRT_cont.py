...
adamEpsilon = 1.0
alpha = 0.3
logFilename = "../out/alt_denseLoss_rRT/alpha_{:.2f}.csv".format(denseLossAlpha)

rRT_model_weights_path = "../out/alt_denseLoss_rRT/alpha_{:.2f}.ckpt".format(denseLossAlpha)
rRT_model, rRT_history = reg.denseLoss_rRTValidation(adamLearningRate, feature_extractor, trainingData_x, trainingData_y, validationData, logFilename, denseLossAlpha, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs, weights_filename=rRT_model_weights_path)
