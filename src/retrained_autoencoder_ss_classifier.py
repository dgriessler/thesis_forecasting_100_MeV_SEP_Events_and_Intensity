...
secondStageTrainingData_x_oversample, secondStageTrainingData_y_oversample = cla.getFirstStageInput("../res/gen/secondStageOversampleAllTraining_percentSEP_0.{}.csv".format(index))
...
for i in range(0, numIterations):
    ...
    logFilename = "../out/classifier/retrained_autoencoder_ss_0_{}/it_{}.csv".format(index, i)

    autoencoder_second_stage_model = cla.autoencoder_second_stage_all(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, logFilename, alpha, seed=1234+i)

    autoencoder_validation_weights_path_ss = "../out/classifier/retrained_autoencoder_ss_0_{}/it_{}.ckpt".format(index, i)
