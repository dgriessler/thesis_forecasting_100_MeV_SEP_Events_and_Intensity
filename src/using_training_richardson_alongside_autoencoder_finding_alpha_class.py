...
logFilenameClassifier = "../out/using_training_richardson_alongside/autoencoder_finding_alpha/autoencoder_finding_alpha_classifier.csv"

autoencoder_validation_weights_path_classifier = "../out/using_training_richardson_alongside/autoencoder_finding_alpha/autoencoder_finding_alpha_classifier.ckpt"

classifier_model = reg.learnedRichardsonAlongside_autoencoder_finding_alpha_class(adamOptimizerClassifier, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilenameClassifier, numEpochs, alpha, autoencoder_validation_weights_path_classifier)

keras.utils.plot_model(classifier_model, to_file='../out/using_training_richardson_alongside/autoencoder_finding_alpha/classifier_finding_alpha_model.png', show_shapes=True, show_layer_names=True)
