...
logFilenameClassifier = "../out/autoencoder_finding_alpha/autoencoder_finding_alpha_classifier.csv"
autoencoder_validation_weights_path_classifier = "../out/autoencoder_finding_alpha/autoencoder_finding_alpha_classifier.ckpt"
...
keras.utils.plot_model(classifier_model, to_file='../out/autoencoder_finding_alpha/classifier_finding_alpha_model.png', show_shapes=True, show_layer_names=True)
