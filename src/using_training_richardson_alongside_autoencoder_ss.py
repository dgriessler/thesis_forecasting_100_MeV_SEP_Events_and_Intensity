...
autoencoder_model = reg.learnedRichardsonAlongside_autoencoder_second_stage(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilename, alpha)

autoencoder_validation_weights_path = "../out/using_training_richardson_alongside/autoencoder_ss_0_{}/autoencoder_ss_0_{}_validation_training.ckpt".format(index, index)
