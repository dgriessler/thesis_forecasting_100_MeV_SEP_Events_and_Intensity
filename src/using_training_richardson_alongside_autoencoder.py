...
logFilename = "../out/using_training_richardson_alongside/autoencoder/autoencoder_validation_training.csv"

autoencoder_model = reg.learnedRichardsonAlongside_autoencoder(adamOptimizer, logFilename, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, numEpochs, alpha)
keras.utils.plot_model(autoencoder_model, to_file='../out/using_training_richardson_alongside/autoencoder/autoencoder_model.png', show_shapes=True, show_layer_names=True)

autoencoder_validation_weights_path = "../out/using_training_richardson_alongside/autoencoder/autoencoder_validation_training.ckpt"
