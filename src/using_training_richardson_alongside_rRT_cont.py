...
rRT_model, _ = reg.learnedRichardsonAlongsideRRTValidation(adamLearningRate, feature_extractor, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, seed=1234+index, numEpochs=numEpochs, weights_filename=rRT_model_weights_path)
