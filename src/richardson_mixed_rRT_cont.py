...
trained_checkpoint_path = "../out/richardson_mixed/regNN/adam_model_001_1.ckpt"
adam_model_001_1, _ = reg.richardsonMixedNN(adamLearningRate, None, None, None, adamEpsilon=adamEpsilon, alpha=alpha, weights_filename=trained_checkpoint_path, doTrain=False)
...
logFilename = "../out/richardson_mixed/rRT_0_{}/rRT_model_0_{}.csv".format(index, index)

rRT_model_weights_path = "../out/richardson_mixed/rRT_0_{}/rRT_model_0_{}.ckpt".format(index, index)
rRT_model, _ = reg.richardsonMixedRRTValidation(adamLearningRate, feature_extractor, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, seed=1234+index, numEpochs=numEpochs, weights_filename=rRT_model_weights_path)
