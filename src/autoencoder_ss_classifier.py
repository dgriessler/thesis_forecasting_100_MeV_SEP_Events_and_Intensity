...
secondStageTrainingData_x_oversample, secondStageTrainingData_y_oversample = cla.getFirstStageInput("../res/gen/secondStageOversampleTraining_percentSEP_0.{}.csv".format(index))
secondStageValidationData_oversample = cla.getValidationData("../res/gen/secondStageOversampleValidation_percentSEP_0.{}.csv".format(index))
...
logFilename = "../out/classifier/autoencoder_ss_0_{}/autoencoder_ss_0_{}_validation_training.csv".format(index, index)

autoencoder_model = cla.autoencoder_second_stage(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilename, alpha)

autoencoder_validation_weights_path = "../out/classifier/autoencoder_ss_0_{}/autoencoder_ss_0_{}_validation_training.ckpt".format(index, index)
