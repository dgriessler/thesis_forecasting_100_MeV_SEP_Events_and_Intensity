...
class EvalRegressionRichardsonMixed(EvalRegression):
    def __init__(self):
        super().__init__()
        self.reg = RegressionRichardsonMixed()
    ...
    def regNN(self):
        resFolder = "../res/gen"
        outFolder = "../out/richardson_mixed/regNN_retrained"
        evalFolder = "../eval/richardson_mixed/regNN_retrained"
        ...
        adam_model_001_1_retrained, adam_history_001_1_retrained = self.reg.richardsonMixedNN(retrained_adamLearningRate, combined_training_data_x, combined_training_data_y, retrained_logFilename, adamEpsilon=retrained_adamEpsilon, alpha=retrained_alpha, weights_filename=retrained_weights_filename, doTrain = False)
    ...
    def regNN_iterate(self):
        resFolder = "../res/gen"
        outFolder = "../out/richardson_mixed/regNN_retrained"
        evalFolder = "../eval/richardson_mixed/regNN_retrained/iterate"
        ...
        for j in range(0, numIterations):
            ...
            adam_model_001_1_retrained, _ = self.reg.richardsonMixedNN(retrained_adamLearningRate, None, None, None, seed=1234+j, adamEpsilon=retrained_adamEpsilon, alpha=retrained_alpha, weights_filename=retrained_weights_filename, doTrain = False)
    ...
    def regNN_oversampled(self, oversampleAmount, testDataFilename, adamLearningRate, adam_epsilon, alpha):
        ...
        outFolder = "../out/richardson_mixed/retrained_regNN_oversampled_0_{}".format(folder_trailer)
        evalFolder = "../eval/richardson_mixed/retrained_regNN_oversampled_0_{}".format(folder_trailer)
        ...
        for j in range(0, numIterations):
            ...
            NNModel, _ = self.reg.richardsonMixedNN(adamLearningRate, None, None, None, seed=1234+j, adamEpsilon=adam_epsilon, alpha=alpha, weights_filename=weights_filename, doTrain = False)
    ...
    def rRT(self, oversampleAmount, testDataFilename, adamLearningRate, adam_epsilon, alpha):
        resFolder = "../res/gen"
        folder_trailer = int(oversampleAmount / 10)
        outFolder = "../out/richardson_mixed/retrained_rRT_0_{}".format(folder_trailer)
        evalFolder = "../eval/richardson_mixed/retrained_rRT_0_{}".format(folder_trailer)
        ...
        for j in range(0, numIterations):
            ...
            retrained_weights_filename = "../out/richardson_mixed/regNN/adam_model_001_1.ckpt"
            adam_model_001_1, _ = self.reg.richardsonMixedNN(retrained_adamLearningRate, None, None, None, adamEpsilon=retrained_adamEpsilon, alpha=retrained_alpha, weights_filename=retrained_weights_filename, doTrain=False)

            feature_extractor = get_feature_extractor(adam_model_001_1, lastHiddenLayerIndex=len(adam_model_001_1.layers) - 2)

            NNModel, _ = self.reg.richardsonMixedRRT(adamLearningRate, feature_extractor, None, None, None, adamEpsilon=adam_epsilon, alpha=alpha, seed=1234+j, weights_filename=weights_filename, do_train=False)
    ...
    def autoencoder(self, oversampleAmount, testDataFilename, adamLearningRate, adam_epsilon, alpha):
        resFolder = "../res/gen"
        folder_trailer = int(oversampleAmount / 10)
        outFolder = "../out/richardson_mixed/retrained_autoencoder_ss_0_{}".format(folder_trailer)
        evalFolder = "../eval/richardson_mixed/retrained_autoencoder_ss_0_{}".format(folder_trailer)
        ...
        for j in range(0, numIterations):
            ...
            autoencoder_second_stage_model = self.reg.richardsonMixed_autoencoder_second_stage_all(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, None, None, None, None, alpha=alpha, weights_filename=weights_filename, train=False, seed=1234+j)
...
if __name__ == "__main__":
    evaluator = EvalRegressionRichardsonMixed()
    evaluator.regNN()
    ...
    adamEpsilon = 1.0
    alpha = 0.3
    evaluator.regNN_oversampled_scaled(50, "secondStageOversampleTest_percentSEP_0.{}.csv".format(5), adamLearningRate, adamEpsilon, alpha, min_x, max_x, min_y, max_y)

    adamLearningRate = 0.001
    adamEpsilon = 1.0
    alpha = 0.3
    evaluator.rRT_scaled(60, "secondStageOversampleTest_percentSEP_0.{}.csv".format(6), adamLearningRate, adamEpsilon, alpha, min_x, max_x, min_y, max_y)

    adamLearningRate = 0.001
    adamEpsilon = 1.0
    alpha = 0.3
    evaluator.autoencoder_scaled(50, "secondStageOversampleTest_percentSEP_0.{}.csv".format(5), adamLearningRate, adamEpsilon, alpha, min_x, max_x, min_y, max_y)
