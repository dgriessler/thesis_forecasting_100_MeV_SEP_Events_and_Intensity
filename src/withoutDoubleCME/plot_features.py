...
#data_x, targets_x, data_y, of_interest = getFeatures("../eval/retrained_autoencoder_ss_0_5/Predictions_F1_0.5714285714285715_3.csv")

data_x, targets_x, data_y, of_interest = getTrainedRichardsonFeatures("../eval/using_trained_richardson/retrained_autoencoder_ss_0_5/Predictions_F1_0_4.csv")
