...
adam_model_001_1, adam_history_001_1 = reg.learnedRichardsonAlongsideRegularNNValidation(adamLearningRate, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs, weights_filename=adam_model_001_01_checkpoint_path)
