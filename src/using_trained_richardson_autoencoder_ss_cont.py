...
logFilename = "../out/using_trained_richardson/autoencoder_ss_0_{}/autoencoder_ss_0_{}_validation_training.csv".format(index, index)

autoencoder_ss_validation_weights_path = "../out/using_trained_richardson/autoencoder_ss_0_{}/autoencoder_ss_0_{}_validation_training.ckpt".format(index, index)
autoencoder_model = reg.autoencoder_second_stage(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilename, alpha, autoencoder_ss_validation_weights_path)


autoencoder_model.save_weights(autoencoder_ss_validation_weights_path)
