...
class Regression(object):
    ...
    def create_learned_richardson_layers(self):
        learned_features = readCSVFile('../res/trained/richardson.csv')
        w_v = float(learned_features[0]['w_v'])
        w_exp = float(learned_features[0]['w_exp'])
    ...
    def learnedRichardsonAlongsideRegularNNValidation(self, adamLearningRate, trainingData_x, trainingData_y, validationData, logFilename, adamEpsilon, alpha, numEpochs=3000, weights_filename=None, doTrain = True):
        ...
        inputRichardsonLayer, outputRichardsonLayer = self.create_learned_richardson_layers()
        ...
        combinedOutputLayer = keras.layers.Dense(1, kernel_initializer=tf.keras.initializers.Ones(), activation=None, use_bias=False, kernel_constraint=h_constraint_2)(combined)
    ...
    def learnedRichardsonAlongsideRegularNN(self, adamLearningRate, trainingData_x, trainingData_y, logFilename, adamEpsilon, alpha, seed=None, numEpochs=3000, weights_filename=None, doTrain = True):
        print("Adam Learning Rate: {:.5f}. Adam epsilon: {:.5f}. Num epochs: {:}.".format(adamLearningRate, adamEpsilon, numEpochs))
    ...
    def learnedRichardsonAlongsideRRTValidation(self, adamLearningRate, model, trainingData_x, trainingData_y, validationData, logFilename, adamEpsilon, alpha, seed, numEpochs=3000, weights_filename=None, do_train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
        ...
        # Hidden layer regular NN
        encoderLayerReg = keras.layers.Dense(16, trainable=False, weights=model.layers[1].weights, activation=LeakyReLU(alpha=alpha))(inputLayerReg)

        zLayerReg = keras.layers.Dense(9, trainable=False, weights=model.layers[3].weights, activation=LeakyReLU(alpha=alpha))(encoderLayerReg)

        nonLinearLayer_ours = keras.layers.Dense(6, kernel_initializer=initializer, activation=LeakyReLU(alpha=alpha))(zLayerReg)

        # Output Layer regular NN, reinitalize
        outputLayerReg = layers.Dense(1, activation=None, kernel_initializer=initializer)(nonLinearLayer_ours)

        combined = keras.layers.concatenate([outputRichardsonLayer, outputLayerReg])

        # Mixing output from regular NN and output from richardson
        combinedOutputLayer = keras.layers.Dense(1, trainable=False, kernel_initializer=tf.keras.initializers.Ones(), activation=None, use_bias=False)(combined)

        modelRetrain = keras.Model(inputs=[inputRichardsonLayer, inputLayerReg], outputs=combinedOutputLayer, name="adapted_rRT_retrain")
        modelRetrain.summary()
    ...
    def learnedRichardsonAlongsideRRT(self, adamLearningRate, model, trainingData_x, trainingData_y, logFilename, adamEpsilon, alpha, seed, numEpochs=3000, weights_filename=None, do_train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
        ...
        if do_train:
            ...
            historyRetrain = modelRetrain.fit(trainingData_x, trainingData_y, epochs=numEpochs, callbacks=callbacks, verbose=0)

        return (modelRetrain, historyRetrain)

    def learnedRichardsonAlongside_autoencoder_finding_alpha_auto(self, optimizer, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilename, numEpochs, weights_filename, alpha):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())

        # Autoencoder
        # Input layer
        inputLayerFirst = keras.layers.Input(shape=(18,))
        ...
        modelFirst = keras.Model(inputs=inputLayerFirst, outputs=autoencoderLayerFirst, name="autoencoder_model")
        modelFirst.summary()
    ...
    def learnedRichardsonAlongside_autoencoder_finding_alpha_class(self, optimizerClassifier, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilenameClassifier, numEpochs, alpha, weights_filename_classifier):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
        ...
        # Classifier
        # Input layer
        inputLayerSecond = keras.layers.Input(shape=(18,))
        ...
        combined = keras.layers.concatenate([outputRichardsonLayer, outputSecond])

        # Mixing output from regular NN and output from richardson
        combinedOutputLayer = keras.layers.Dense(1, trainable=False, kernel_initializer=tf.keras.initializers.Ones(), activation=None, use_bias=False)(combined)
   
        modelSecond = keras.Model(inputs=[inputRichardsonLayer, inputLayerSecond], outputs=combinedOutputLayer, name="autoencoder_classifier_model")
        modelSecond.summary()
    ...
    def learnedRichardsonAlongside_autoencoder(self, optimizer, logFilename, trainingData_x, trainingData_y, validationData, numEpochs, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
        ...
        # Autoencoder
        # Input layer
        inputLayer = keras.layers.Input(shape=(18,))
        ...
        combined = keras.layers.concatenate([outputRichardsonLayer, classiferLayer])

        # Mixing output from regular NN and output from richardson
        combinedOutputLayer = keras.layers.Dense(1, trainable=False, kernel_initializer=tf.keras.initializers.Ones(), activation=None, use_bias=False)(combined)

        outputs = [autoencoderLayer, combinedOutputLayer]

        model = keras.Model(inputs=[inputRichardsonLayer, inputLayer], outputs=outputs, name="autoencoder_model")
        model.summary()
    ...
    def learnedRichardsonAlongside_autoencoderAll(self, optimizer, logFilename, trainingData_x, trainingData_y, numEpochs, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
    ...
    def learnedRichardsonAlongside_autoencoder_second_stage(self, autoencoder_validation_weights_path, optimizer, optimizer_ss, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, validationData, logFilename, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
        ...
        autoencoder_first_stage = keras.Model(inputs=[inputRichardsonLayer, inputLayer], outputs=outputs, name="autoencoder_model")
        autoencoder_first_stage.summary()
        ...
        inputRichardsonLayer_ss, outputRichardsonLayer_ss = self.create_learned_richardson_layers()

        # Input layer
        inputLayer_ss = keras.layers.Input(shape=(18,))
        ...
        combined_ss = keras.layers.concatenate([outputRichardsonLayer_ss, classiferLayer_ss])

        # Mixing output from regular NN and output from richardson
        combinedOutputLayer_ss = keras.layers.Dense(1, trainable=False, kernel_initializer=tf.keras.initializers.Ones(), activation=None, use_bias=False)(combined_ss)

        outputs_ss = combinedOutputLayer_ss

        autoencoder_second_stage_model = keras.Model(inputs=[inputRichardsonLayer_ss, inputLayer_ss], outputs=outputs_ss, name="autoencoder_model")
        autoencoder_second_stage_model.summary()
    ...
    def learnedRichardsonAlongside_autoencoder_second_stage_all(self, autoencoder_validation_weights_path, optimizer, optimizer_ss, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, logFilename, alpha, seed, weights_filename=None, train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
    ...
    def richardsonMixedNNValidation(self, adamLearningRate, trainingData_x, trainingData_y, validationData, logFilename, adamEpsilon, alpha, numEpochs=3000, weights_filename=None, doTrain = True):
        print("Adam Learning Rate: {:.5f}. Adam epsilon: {:.5f}. Num epochs: {:}.".format(adamLearningRate, adamEpsilon, numEpochs))
    ...
    def richardsonMixedNN(self, adamLearningRate, trainingData_x, trainingData_y, logFilename, adamEpsilon, alpha, seed=None, numEpochs=3000, weights_filename=None, doTrain = True):
        print("Adam Learning Rate: {:.5f}. Adam epsilon: {:.5f}. Num epochs: {:}.".format(adamLearningRate, adamEpsilon, numEpochs))
    ...
    def richardsonMixedRRTValidation(self, adamLearningRate, model, trainingData_x, trainingData_y, validationData, logFilename, adamEpsilon, alpha, seed, numEpochs=3000, weights_filename=None, do_train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
    ...
    def richardsonMixedRRT(self, adamLearningRate, model, trainingData_x, trainingData_y, logFilename, adamEpsilon, alpha, seed, numEpochs=3000, weights_filename=None, do_train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
    ...
    def richardsonMixed_autoencoder_finding_alpha_auto(self, optimizer, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilename, numEpochs, weights_filename, alpha):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
    ...
    def richardsonMixed_autoencoder_finding_alpha_class(self, optimizerClassifier, autoencoder_trainingData_x, autoencoder_trainingData_y, autoencoder_validationData, logFilenameClassifier, numEpochs, alpha, weights_filename_classifier):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
    ...
    def richardsonMixed_autoencoder(self, optimizer, logFilename, trainingData_x, trainingData_y, validationData, numEpochs, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
    ...
    def richardsonMixed_autoencoderAll(self, optimizer, logFilename, trainingData_x, trainingData_y, numEpochs, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
    ...
    def richardsonMixed_autoencoder_second_stage(self, autoencoder_validation_weights_path, optimizer, optimizer_ss, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, validationData, logFilename, alpha, weights_filename=None):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=getNextSeed())
        ...
        # Mixing output from regular NN and output from richardson
        combinedOutputLayer_ss = keras.layers.Dense(1, kernel_initializer=initializer_ss, activation=None)(combined_ss)
    ...
    def richardsonMixed_autoencoder_second_stage_all(self, autoencoder_validation_weights_path, optimizer, optimizer_ss, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, logFilename, alpha, seed, weights_filename=None, train=True):
        initializer = keras.initializers.RandomUniform(minval=-0.05, maxval=0.05, seed=seed)
