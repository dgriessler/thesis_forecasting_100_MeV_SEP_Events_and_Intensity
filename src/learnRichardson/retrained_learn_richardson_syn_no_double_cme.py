...
richardson_trainingData_x, richardson_trainingData_y  = reg.getFirstStageInputRichardson("../res/gen/syn/no_double_cme_firstStageAllTrainingSyn.csv", useSynData=True)
...
adam_model_001_1_checkpoint_path = "../out/retrained_learn_richardson_syn_no_double_cme/adam_model_001_1_reg_init.ckpt"
