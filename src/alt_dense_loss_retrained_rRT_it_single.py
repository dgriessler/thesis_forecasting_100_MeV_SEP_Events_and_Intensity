...
adamEpsilon = 1.0
alpha = 0.3
logFilename = "../out/alt_denseLoss_retrained_rRT/alpha_{:.2f}_it_{}.csv".format(denseLossAlpha, i)
...
rRT_model_weights_path = "../out/alt_denseLoss_retrained_rRT/alpha_{:.2f}_it_{}.ckpt".format(denseLossAlpha, i)
