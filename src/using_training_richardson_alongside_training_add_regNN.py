...
logFilename = "../out/using_training_richardson_alongside_training_add/regNN/adam_model_001_1.csv"
numEpochs = 25000

adam_model_001_1, _ = reg.learnedRichardsonAlongsideRegularNNLearningAddingValidation(adamLearningRate, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs)
adam_model_001_1_checkpoint_path = "../out/using_training_richardson_alongside_training_add/regNN/adam_model_001_1.ckpt"
adam_model_001_1.save_weights(adam_model_001_1_checkpoint_path)

keras.utils.plot_model(adam_model_001_1, to_file="model.png")
