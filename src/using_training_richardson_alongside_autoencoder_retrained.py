...
logFilename = "../out/using_training_richardson_alongside/autoencoder_retrained/autoencoder_validation_training.csv"

autoencoder_model = reg.learnedRichardsonAlongside_autoencoderAll(adamOptimizer, logFilename, autoencoder_trainingData_x, autoencoder_trainingData_y, numEpochs, alpha)
keras.utils.plot_model(autoencoder_model, to_file='../out/using_training_richardson_alongside/autoencoder_retrained/autoencoder_model.png', show_shapes=True, show_layer_names=True)
