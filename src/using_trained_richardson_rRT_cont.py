...
rRT_model, rRT_history = reg.rRTValidation(adamLearningRate, feature_extractor, secondStageTrainingData_x_oversample, secondStageTrainingData_y_oversample, secondStageValidationData_oversample, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs, weights_filename=rRT_model_weights_path)
