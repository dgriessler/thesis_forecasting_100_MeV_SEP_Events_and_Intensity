...
adamEpsilon = 1.0
alpha = 0.3
logFilename = "../out/learn_richardson_on_syn_3fold/group_{}_subset_{}.csv".format(group, subset)
numEpochs = 180000
...
adam_model_001_1_checkpoint_path = "../out/learn_richardson_on_syn_3fold/group_{}_subset_{}.ckpt".format(group, subset)
