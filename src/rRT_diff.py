...
adamEpsilon = 1e-7
alpha = 0.3
logFilename = "../out/rRT_0_{}/rRT_model_adamEpsilon_1e-7_0_{}.csv".format(index, index)
numEpochs = 10000
...
rRT_model_weights_path = "../out/rRT_0_{}/rRT_model_adamEpsilon_1e-7_0_{}.ckpt".format(index, index)
