...
for i in range(0, numIterations):
    ...
    logFilename = "../out/richardson_mixed/retrained_rRT_0_{}/it_{}.csv".format(index, i)
    rRT_model, _ = reg.richardsonMixedRRT(adamLearningRate, feature_extractor, combined_training_data_x, combined_training_data_y, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, seed=1234+i, numEpochs=numEpochs)

    rRT_model_weights_path = "../out/richardson_mixed/retrained_rRT_0_{}/it_{}.ckpt".format(index, i)
