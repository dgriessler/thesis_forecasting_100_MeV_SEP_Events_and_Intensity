...
for i in range(0, 5):
    ...
    logFilename = "../out/using_training_richardson_alongside/retrained_autoencoder_ss_0_{}/it_{}.csv".format(index, i)

    autoencoder_model = reg.learnedRichardsonAlongside_autoencoder_second_stage_all(autoencoder_validation_weights_path, adamOptimizer, adamOptimizerSS, numEpochs, autoencoder_trainingData_x, autoencoder_trainingData_y, logFilename, alpha, 1234+i)

    save_weights_filename = "../out/using_training_richardson_alongside/retrained_autoencoder_ss_0_{}/it_{}.ckpt".format(index, i)
