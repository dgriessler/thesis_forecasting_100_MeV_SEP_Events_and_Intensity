...
adamEpsilon = 1.0
alpha = 0.3
logFilename = "../out/denseLoss_retrained/alpha_{:.2f}_it_{}.csv".format(denseLossAlpha, i)
...
adam_model_001_1_checkpoint_path = "../out/denseLoss_retrained/alpha_{:.2f}_it_{}.ckpt".format(denseLossAlpha, i)
