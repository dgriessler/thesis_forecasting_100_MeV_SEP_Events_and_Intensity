...
adam_model_001_1, _ = reg.learnedRichardsonAlongsideRegularNNValidation(adamLearningRate, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs)
...
keras.utils.plot_model(adam_model_001_1, to_file="../out/using_training_richardson_alongside/regNN/model.png")
