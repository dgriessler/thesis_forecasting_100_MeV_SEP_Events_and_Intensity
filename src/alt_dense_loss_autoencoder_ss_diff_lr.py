...
logFilename = "../out/alt_denseLoss_autoencoder_ss/lr_{:.4f}_alpha_{:.2f}.csv".format(adamLearningRate, denseLossAlpha)
...
autoencoder_validation_weights_path = "../out/alt_denseLoss_autoencoder_ss/lr_{:.4f}_alpha_{:.2f}.ckpt".format(adamLearningRate, denseLossAlpha)
