...
baseStr = "../out/richardson_mixed/regNN_oversampled_0_{}/adam_model_001_01_oversampled_0_{}".format(index, index)
...
adam_model_001_1, adam_history_001_1 = reg.richardsonMixedNNValidation(adamLearningRate, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, numEpochs=numEpochs)
