...
rRT_model, _ = reg.richardsonMixedRRTValidation(adamLearningRate, feature_extractor, combined_training_data_x, combined_training_data_y, combined_validation_data, logFilename, adamEpsilon=adamEpsilon, alpha=alpha, seed=1234+index, numEpochs=numEpochs)
