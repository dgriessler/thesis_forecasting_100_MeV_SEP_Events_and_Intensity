...
retrained_alpha = 0.3
retrained_logFilename = "../out/using_trained_richardson/regNN_retrained/adam_model_001_1_retrained.csv"
...
all_trainingData_x_0_1, all_trainingData_y_0_1 = reg.getFirstStageInput("../res/trained/secondStageOversampleAllTraining_percentSEP_0.{}.csv".format(index))
testData_x_0_1, testData_y_0_1 = reg.getFirstStageInput("../res/trained/secondStageOversampleTest_percentSEP_0.{}.csv".format(index))
testData_target_0_1 = reg.getTargets("../res/trained/secondStageOversampleTest_percentSEP_0.{}.csv".format(index))
...
for i in range(0, numIterations):
    ...
    logFilename = "../out/using_trained_richardson/retrained_rRT_0_{}/it_{}.csv".format(index, i)
    ...
    NNmodel_weights_path = "../out/using_trained_richardson/retrained_rRT_0_{}/it_{}.ckpt".format(index, i)
