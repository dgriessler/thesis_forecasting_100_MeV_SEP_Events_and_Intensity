...
logFilename = "../out/alt_denseLoss_retrained_autoencoder_ss/alpha_{:.2f}_it_{}.csv".format(denseLossAlpha, i)
...
save_weights_path = "../out/alt_denseLoss_retrained_autoencoder_ss/alpha_{:.2f}_it_{}.ckpt".format(denseLossAlpha, i)
