...
alpha = 0.3
logFilename = "../out/classifier/rRT_0_{}/rRT_model_0.0001_0_{}.csv".format(index, index)
numEpochs = 50000
...
rRT_model, rRT_history = cla.rRTValidation(adamLearningRate, adam_model_001_1_retrained, secondStageTrainingData_x, secondStageTrainingData_y, secondStageValidationData, logFilename, alpha=alpha, numEpochs=numEpochs)

rRT_model_weights_path = "../out/classifier/rRT_0_{}/rRT_model_0.0001_0_{}.ckpt".format(index, index)
